...
from .qullamaggie_breakout_family import detect_qullamaggie_breakout_family
from .qullamaggie_ep_family import detect_qullamaggie_ep_family
...
DETECTOR_REGISTRY: dict[str, DetectorFn] = {
    ...
    'qullamaggie_breakout_family': detect_qullamaggie_breakout_family,
    'qullamaggie_ep_family': detect_qullamaggie_ep_family,
}
...
__all__ = [
    ...
    'detect_qullamaggie_breakout_family',
    'detect_qullamaggie_ep_family',
